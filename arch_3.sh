...
sudo pacman -S lxappearance vim rtorrent mplayer ufw nodejs ntfs-3g dmenu feh alsa-lib alsa-utils chromium terminator p7zip unrar pulseaudio --noconfirm
aurman -S sublime-text-dev dropbox arc-gtk-theme openvpn evince --noconfirm
